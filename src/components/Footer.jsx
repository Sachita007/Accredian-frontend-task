...
function Footer() {
    return (
        <div id="footer" className='flex justify-center flex-col items-center bg-[#282828]'>
            <div className='flex justify-between mt-[2rem] w-[80%] md:w-[60%] '>
                <div> <img width={"150px"} src={logo2}></img></div>
                <div>
                    <div><button className='bg-blue-500 text-white px-6 py-3 rounded-lg hover:bg-blue-600 border border-gray-50'>Schedule 1-on-1 Call Now
                    </button>
                        <div className='text-white'>Speak with our Learning Advisor</div>
                    </div>
                </div>
            </div>
            <div className='w-[80%] md:w-[60%] h-[1px] bg-gray-400 my-8 '></div>
            <footer className="py-6 text-white ">
                <div className="flex md:gap-[8rem] flex-col sm:flex-row ">
                    ...
                    <div className="flex flex-col space-y-4">
                        ...
                        <div className="flex flex-col w-[400px] space-y-2 text-sm ">
                            <a rel="noopener noreferrer" href="#">Email us (For Data Science Queries): admissions@accredian.com
                                ...
                                Haryana 122015</a>
                            <a rel="noopener noreferrer" href="#">Why Accredian</a>
                            <a rel="noopener noreferrer" href="#">Follow Us</a>
                    ...
                    <div className="flex flex-col space-y-4">
                        <h2 className="font-medium">Accredian</h2>
                        <div className="flex flex-col space-y-2 text-sm ">
                ...
                <div className="flex items-center justify-center px-6 pt-12 text-sm">
                    <span className="dark:text-gray-600">© Copyright 2024</span>
                </div>
            </footer>
        </div>
    )
